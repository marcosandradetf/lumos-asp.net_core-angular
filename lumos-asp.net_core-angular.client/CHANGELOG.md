...
- Create Angular project with ng: `ng new lumos-asp.net_core-angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`lumos-asp.net_core-angular.client.esproj`).
